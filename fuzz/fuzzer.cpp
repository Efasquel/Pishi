/*
build:
 ../clang -fsanitize=fuzzer -isysroot $(xcrun --show-sdk-path)
/Users/meysam/projects/macho/cov/hello.mm -o meysam
 */
...
#define PISHI_IOCTL_MAP _IOWR('K', 8, struct pishi_buf_desc) // change to _IOR
