...
def main():
    ...
    input_kext = askString(
        "Which Kexts should we use for instrumentation? if you want to use ranges from config.json, enter config.json",
        "Please enter kext names(e.g com.apple.iokit.IOSurface).",
    )
